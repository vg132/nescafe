...
namespace Nescafe
{
	class Ui : Form
	{
		...
		unsafe void Draw(byte[] screen)
		{
			...
			var width = (int)Math.Round((panel1.Size.Height) * 1.0666666666666666666666666666667, 0);
			var height = panel1.Size.Height;
			var x = 0;
			if (width < panel1.Size.Width)
			{
		...
		private void InitializeComponent()
		{
			...
			// panel1
			// 
			this.panel1.Location = new System.Drawing.Point(159, 122);
